...
function init_gear_sets()
    ...
    main="Mistilteinn", sub="Flat Shield", head="Goliard Chapeau", body="Mahatma Hpl.", hands="Dvt. Mitts +1", legs="Mahatma Slops", 
    ...
    -- Idle sets
    sets.idle = {
    main=gear.Staff.PDT, sub="Vivid Strap +1", ammo="Hedgehog Bomb", head="Smn. Horn", body="Yinyang Robe", hands="Smn. Bracers +1",
