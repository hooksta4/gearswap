...
function init_gear_sets()
    ...
    main="Chatoyant Staff" ,sub= "Vivid Strap +1", ammo="Bibiki Seashell",
    ...
    sets.midcast.Cure = {
    main="Chatoyant Staff" , sub= "Vivid Strap +1", ammo="White Tathlum",
    head="Goliard Chapeau", neck="Fylgja Torque +1", lear="Roundel Earring", rear="Celestial Earring",
    body="Aristocrat's Coat", hands="Blessed Mitts +1", ring1="Celestial Ring", ring2="Celestial Ring",
    back="Dew Silk Cape +1", waist=gear.ElementalObi, legs="Blessed Trousers +1", feet="Clr. Duckbills +1" }
    ...
    main="Kirin's Pole" ,neck="Promise Badge", ring1="Celestial Ring", ring2="Celestial Ring", hands="Blessed Mitts +1",
    ...
    -- Resting sets
    sets.resting = {
    main="Imperial Wand", sub="Legion Scutum",
    ...
    sets.idle = {
    main="Chatoyant Staff", sub = "Vivid Strap +1", head = "Maat's Cap", body="Aristocrat's Coat", hands="Blessed Mitts +1", feet="Herald's Gaiters", back="Umbra Cape", waist="Resolute Belt",
    ...
    sets.idle.Weak = {
    main="Terra's Staff",sub = "Vivid Strap +1", body="Ixion Cloak", feet="Herald's Gaiters", back="Umbra Cape", waist="Resolute Belt",
    neck="Orochi Nodowa +1", lear="Merman's Earring", ring1="Merman's Ring", rear="Merman's Earring", ring2="Merman's Ring" }
