...
function get_sets()
	...
	sets.SanguineBlade = { -- KOR set 40% STR 40% MND
		ammo = "Tiphia Sting",
		head = "Wivre Mask +1",
		neck = "Chivalrous Chain",
		ear1 = "Harmonius Earring",
	...
	sets.BlueMagic.INT.MAB = {
		ammo = "Phantom Tathlum",
		head = "Nashira Turban",--Maybe switch out with +int opposed to MACC or vice versa
		neck = "Lemegeton Medallion +1",
		ear1 = "Hermetic Earring",-- Get
		ear2 = "Friomisi earring",--get
	...
	sets.BlueMagic.Skill = {
		...
		ring1 = "Kishar Ring",--antica ring
		ring2 = "Stikini Ring",
		back = "Cornflower cape",
		waist = "Gishdubar Sash",--Ksi sash 
		legs = "Hashishin Tayt +1",
...
function pc_JA(spell, act)
	...
	if spell.type == 'WeaponSkill' then
		...
		elseif spell.english == 'Chant du Cygne' or spell.english == 'Vorpal Blade' then --Vorpal = 60% STR
