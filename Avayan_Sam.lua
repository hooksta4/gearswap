function get_sets()
	...
	include('Cona-Include.lua')
        ...
        options = { usePDT = false, meleeMode = 'DD', autopilot = false,
                HUD = { x = 1500, y = 100, visible = false, trendSize = 25  }
        }
	build_HUD()
	Autows 			= 0
	auto 			=1
	...
	-- Idle/Town Sets --
	sets.Idle = {head="Wakido Kabuto +2",neck="Asperity Necklace",ear1="Bladeborn Earring",ear2="Steelflash Earring",
        body="Wakido domaru +1",hands="Wakido kote +1",ring1="Rajas Ring",ring2="Defending ring",
        back="Takaha Mantle",waist="Windbuffet Belt +1",legs="Wakido haidate +1",feet="Danzo Sune-ate"}
	sets.Idle['Regen'] = {
			head="Gavialis Helm",
			neck="Wiglen Gorget",
			body="Kyujutsugi",
	...
	sets.Idle['Movement'] = set_combine(sets.Idle.Regen,{
		head="Wakido Kabuto +2",neck="Asperity Necklace",ear1="Bladeborn Earring",ear2="Steelflash Earring",
        body="Wakido domaru +1",hands="Wakido kote +1",ring1="Rajas Ring",ring2="Defending ring",
        back="Takaha Mantle",waist="Windbuffet Belt +1",legs="Wakido haidate +1",feet="Danzo Sune-ate"})
	...
	sets.TP.Kogarasumaru.Ionis =  set_combine(sets.TP.Kogarasumaru,{        head="Sakonji Kabuto",neck="Asperity Necklace",ear1="Bladeborn Earring",ear2="Steelflash Earring",
        body="Wakido domaru +1",hands="Wakido kote +1",ring1="Rajas Ring",ring2="hetairoi ring",
        back="Takaha Mantle",waist="Windbuffet Belt +1",legs="Wakido haidate +1",feet="Sakonji Sune-ate +1"})
	...
	-- Kurikaranotachi TP Sets --
	
	--	sets.TP.Kurikaranotachi = {
		--range="Yoichinoyumi",
		--	--ammo="Tulfaire Arrow",
		--	head="Sakonji kabuto +1",
		--	neck="Ganesha's Mala",
	...
	sets.TP.Kurikaranotachi =  {
        ...
        body="Wakido domaru +1",hands="Flamma manopolas +1",ring1="Rajas Ring",ring2="Flamma ring",
        back="Smertrios's Mantle",waist="Windbuffet Belt +1",legs="Wakido haidate +1",feet="Flamma gambieras +1"
			...
			--60--
	sets.TP.Kurikaranotachi.AvgACC = set_combine(sets.TP.Kurikaranotachi,{
	       -- head="Yaoyotl Helm",
          --  back="Takaha Mantle",
			--right_ring="Oneiros ring",
			})
			--58--
	sets.TP.Kurikaranotachi.MidACC = set_combine(sets.TP.Kurikaranotachi.AvgACC,{
			...
			back="Takaha Mantle"})
	sets.TP.Kurikaranotachi.HighACC = set_combine(sets.TP.Kurikaranotachi.MidACC,{
			...
			ring2="Mars's ring",
			ring1="Rajas Ring"})
	sets.TP.Kurikaranotachi.OshiACC = set_combine(sets.TP.Kurikaranotachi.OshiACC,{})

	-- Kurikaranotachi(Ionis) TP Sets --
	sets.TP.Kurikaranotachi.Ionis ={
	    head="Flamma Zucchetto +1",neck="Asperity Necklace",ear1="Bladeborn Earring",ear2="Steelflash Earring",
        body="Wakido domaru +1",hands="Flamma manopolas +1",ring1="Rajas Ring",ring2="Flamma ring",
        back="Takaha Mantle",waist="Windbuffet Belt +1",legs="Wakido haidate +1",feet="Flamma gambieras +1"
   ...
   -- back="Misuuchi Kappa"
	...
	sets.TP.Kurikaranotachi.AvgACC.Ionis = set_combine(sets.TP.Kurikaranotachi.Ionis,{
                        back="Takaha Mantle",
						})
	sets.TP.Kurikaranotachi.MidACC.Ionis = set_combine(sets.TP.Kurikaranotachi.AvgACC.Ionis,{
                        neck="Iqabi Necklace",
                        back="Takaha Mantle",
                        waist="Olseni Belt",
                        feet="Wakido Sune-ate +1"})
	sets.TP.Kurikaranotachi.HighACC.Ionis ={  
	sub="Bloodrain Strap",
	head="Yaoyotl Helm",
    body="Xaddi Mail",
    hands="Sakonji Kote +1",
    ...
    back="Letalis Mantle"}
	sets.TP.Kurikaranotachi.OshiACC.Ionis = set_combine(sets.TP.Kurikaranotachi.OshiACC.Ionis,{})
	...
	-- JA Sets --
	sets.JA = {}
	sets.JA['Meditate'] = {head="Wakido Kabuto +2",hands="Sakonji Kote",back="Smertrios's Mantle"}--Sakonji Kote +1
	sets.JA['Warding Circle'] = {head="Wakido Kabuto +2"}
	sets.JA['Meikyo Shisui'] = {feet="Sak. Sune-Ate"}
	sets.Waltz = {}
...
function aftercast(spell,action)
	...
	elseif spell.english =="Meditate" then -- Meditate Countdown--
		send_command('wait 140;input /echo '..spell.name..' Effect: [AVAILABLE IN 10 SEC.];wait 10;input /echo'..spell.name..' Effect: [OFF]')
	end
