 ...
 -- Debuff Midcast. 
  ...
  -- Skill is 1/3 Macc.
    ...
    sets.debuff = {
		...
		body        = "Mahatma Houpelande",
		hands		= "Bricta's Cuffs",
		left_ring   = "Heavens Ring",
        right_ring  = "Minstrel's Ring",
		back        = "Birdman Cape",
...
send_command('wait 1;gs equip MDT; wait 2;input /lockstyleset 16 ;wait 1; input /macro book 4; wait 2; input /macro set 10')