...
function get_sets()
	...
	sets.ws.acc.easy = set_combine(sets.melee.easy,{
		...
		feet		="Hct. Leggings +1",
		neck		="Ancient Torque",
		waist		="Warwolf Belt", --Fotia Gorget
	...
	sets.highjump = set_combine(sets.jump,{ -- Wym. Brais +1
		legs		= "Wym. Brais +1"
	})
...
send_command('wait 2;gs equip weapons.main;wait 1;input /lockstyleset 7;wait 1;gs equip idle;wait 1;input /macro book 12')
