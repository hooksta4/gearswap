function get_sets()
	...
	-- Idle/Town Sets --
	sets.Idle = {head="Wakido kabuto +1",neck="Asperity Necklace",ear1="Bladeborn Earring",ear2="Steelflash Earring",
        body="Wakido domaru +1",hands="Wakido kote +1",ring1="Rajas Ring",ring2="Defending ring",
        back="Takaha Mantle",waist="Dynamic Belt +1",legs="Wakido haidate +1",feet="Wakido sune-ate +1"}
	sets.Idle['Regen'] = {
			head="Gavialis Helm",
			neck="Wiglen Gorget",
			body="Kyujutsugi",
	...
	-- JA Sets --
	sets.JA = {}
	sets.JA['Meditate'] = {head="Wakido Kabuto +1",hands="Sakonji Kote",back="Smertrios's Mantle"}--Sakonji Kote +1
