...
function user_setup()
    ...
    send_command('bind ^` input /pet "Assault" <t>')
...
function init_gear_sets()
    ...
    body="Yinyang Robe", head="Penance Hat", hands="Smn. Bracers +1", legs="Summoner's Spats", feet="Smn. Pigaches +1" }
    ...
    head="Walahra Turban", body="Goliard Saio", rear="Loquacious Earring" }

    sets.midcast.Cure = { main="Chatoyant Staff" }

    sets.midcast.Stoneskin = {
    main="Mistilteinn", sub="Flat Shield", head="Mirror Tiara", body="Mahatma Hpl.", hands="Dvt. Mitts +1", legs="Mahatma Slops", 
    feet="", neck="Promise Badge", waist="Pythia Sash +1", left_ear="Celestial Earring", right_ear="Celestial Earring",
    left_ring="Celestial Ring", right_ring="Celestial Ring", back="Prism Cape"  }
	...
	head="Mirror Tiara", neck="Beak Necklace +1", lear="Rapture Earring", rear="Antivenom Earring",
    body="Mahatma Hpl.", hands="Zenith Mitts +1", ring1="Celestial Ring", ring2="Celestial Ring", back="Invigorating Cape",
    waist="Qiqirn Sash +1", legs="Oracle's Braconi", feet="Avocat Pigaches" }
    
    -- Idle sets
    sets.idle = {
    main=gear.Staff.PDT, sub="Vivid Strap +1", ammo="Hedgehog Bomb", head="Summoner's Horn", body="Yinyang Robe", hands="Smn. Bracers +1",
    back="Umbra Cape", legs="Summoner's Spats", feet="Herald's Gaiters", lear="Merman's Earring", rear="Merman's Earring",
    ...
    legs="Oracle's braconi", feet="Herald's Gaiters", lring="Evoker's Ring"  }
    ...
    sets.perp = {
    main="Chatoyant Staff" , lring="Evoker's Ring", body="Penance Robe", head="Evoker's Horn", legs="Oracle's Braconi" }
    ...
    sets.perp.Weather = {
    main="Chatoyant Staff" , head="Evoker's Horn", lring="Evoker's Ring", body="Penance Robe" }
    ...
    sets.perp.Garuda = {
    main="Chatoyant Staff", head="Karura Hachigane", body="Penance Robe", lring="Evoker's Ring" }
    -- Diabolos's Rope doesn't gain us anything at this time
    --sets.perp.Diabolos = {waist="Diabolos's Rope"}
    sets.perp.Alexander = sets.midcast.Pet.BloodPactWard

    sets.perp.staff_and_grip = {
    main="Chatoyant Staff", head="Evoker's Horn", legs="Oracle's Braconi"  }
