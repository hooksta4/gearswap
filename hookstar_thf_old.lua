...
function init_gear_sets()
    ...
    sets.TreasureHunter = { head="White Rarab Cap +1", hands="Plunderer's Armlets +1", feet="Skulker's Poulaines +2", waist="Chaac Belt", legs="Volte Hose"}
